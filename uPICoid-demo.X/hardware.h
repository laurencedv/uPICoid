...
// =================== Define =================== //
// -- Clock -- //
#define OSC				40000000					//Freq of the main OSC source (in Hz)
...
// -- Processor -- //
#define CPU_FAMILY		PIC32MX2xx					//Processor Family used in this project
...
// -- UART -- //
#define UART_MAX_PORT	0							//Maximum number of UART peripherals used
// ---------- //
